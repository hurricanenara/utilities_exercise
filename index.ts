...
const dobbyFollowers: Pick<Member, 'username' | 'imgUrl'>[] = [
...
*/
type LessInfo = Exclude<SocketReadyState, 'closed'>;
const allStatesExceptClosed: LessInfo[] = [
  'opening',
  'open',
  'readOnly',
  'writeOnly',
]; // ✅
// const iShouldntCompile: LessInfo[] = [
//   'opening',
//   'open',
//   'readOnly',
//   'writeOnly',
...
const states: Record<LessInfo, LessInfo> = {
  opening: 'opening',
  open: 'open',
  readOnly: 'readOnly',
  writeOnly: 'writeOnly',
...
type CustomType = NonNullable<QueryParam>;
