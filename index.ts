...
const dobbyFollowers: Pick<Member, 'username' | 'imgUrl'>[] = [{ username: "harry", imgUrl: "harry.jpg" }];
...
//   isServer: true,
//   server: , // net.Server 타입 어떻게?
//   session: ,  // Buffer 타입 어떻게?
//   requestOCSP: true,
//   // ...
// };
...
const allStatesExceptClosed: Exclude<SocketReadyState, 'closed'>[] = ["opening", "open", "readOnly", "writeOnly"]; // ✅
// const iShouldntCompile: Exclude<SocketReadyState, 'closed'>[] = ["opening", "open", "readOnly", "writeOnly", "closed"]; // ❌
...
type statesType = {
  [key in excludeType]: excludeType
}
...
// import { MemoryUsage } from 'process';  // ?? 모듈 가져오질 못함
...
type CustomType = string | null | undefined;
...
type TGetUserNameReturn = nonNullableType
...
type TGetUserReturn = Required<User>
